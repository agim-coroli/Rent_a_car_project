...
<body>
    ...
    <div class="reservation-container">
        ...
        <div class="reservation-info">
            ...
            <div>
                <p>Caution : <?= htmlspecialchars($vehiculeToReserve->getCaution()) ?> €</p>
                <p>Prix : <?= htmlspecialchars($vehiculeToReserve->getPrix()) ?>€/j</p>
                <p>Carburant : <?= htmlspecialchars($vehiculeToReserve->getCarburant()) ?></p>
                <p>Km inclus : <?= htmlspecialchars($vehiculeToReserve->getKminclus()) ?></p>
                <p>Nombre de sièges : <?= htmlspecialchars($vehiculeToReserve->getNombreSiege()) ?></p>
                <p>Transmission : <?= htmlspecialchars($vehiculeToReserve->getTransmission()) ?></p>
                <p>Navigateur GPS : <?= htmlspecialchars($vehiculeToReserve->getNavigateurGps()) ?></p>
            </div>
            <!-- Formulaire de réservation -->
            <form class="reservation-form" method="post">


                <div class="reservation-form-debut">
                    <label for="date_debut">Date et heure de début </label>
                    <input type="datetime-local" id="date_debut" name="date_debut" >
                </div>

                <div class="reservation-form-fin">
